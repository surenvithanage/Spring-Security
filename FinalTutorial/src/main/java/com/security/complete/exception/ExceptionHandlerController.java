package com.security.complete.exception;
...
import com.security.complete.dto.ErrorResponse;
...
public class ExceptionHandlerController {
    /**
     * This method will handle globally thrown MethodArgumentNotValid Exceptions
    ...
    public ErrorResponse handleTokenExpiredException(TokenExpiredException ex) {
        ErrorResponse errorResponse = new ErrorResponse("02", "Token Expired !");
        return errorResponse;
    }
}
